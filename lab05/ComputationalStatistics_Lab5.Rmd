...
Therefore we cannot reject the $H_0$ hypothesis.
...
We see that for $\alpha$s around $1.0$ we fail to reject the $H_0$ hypothesis. As this is a two-sided test we expect some values where we fail to reject $H_0$ which we can observe here.
