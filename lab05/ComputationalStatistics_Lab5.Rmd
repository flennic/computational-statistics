...
ggplot(prices) +
  ...
  geom_vline(aes(xintercept = prices_mean), color = "#581845") +
...
# The next line according to slides, but does this make sense?
...
bootstrap_mean_price = as.numeric(var(house_bootstrap$t))
