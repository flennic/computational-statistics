...
**Answer:** Yes it seems like that those two variables are related to each other as they have spakes in the same areas. It ssems like that we have some kind of cyclical behavior. The amplitude of our spikes decreases with increasing X. It looks like a damped oscillation.
