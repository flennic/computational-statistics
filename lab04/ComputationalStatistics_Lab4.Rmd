...
The following plot shows `10.000` samples with $x_0 = 40$ as a starting point and burn-in iterations set to `10`.
...
Again you can see  `10.000` samples with $x_0 = 500$ as a starting point and burn-in iterations set to `75`.
