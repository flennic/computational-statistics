...
**Answer:** As we know it's a gamma distribution where the integral over `D` is `1` and we also know the constant `C` given from above, we know that the integral has to add upp to $1 * 120 = 120$.
