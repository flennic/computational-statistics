...
#'
#' @examples
metropolis_hasting = function(n = 1, x_0 = 1, b = 50, proposal = "lnorm",
                              keep_burnin = FALSE) {
...
results = metropolis_hasting(100, x_0 = 40, b = burnin, proposal = "lnorm",
                             keep_burnin = TRUE)
...
results = metropolis_hasting(10000, x_0 = 5, b = 100, proposal = "lnorm")

plotdf = data.frame(results)

ggplot(plotdf) +
  geom_histogram(aes(x = results),
                 color = "#000000", fill = "#C70039", bins = length(results)/100) +
...
results = metropolis_hasting(10000, x_0 = 5, b = 100, proposal = "chisquared")
...
results = metropolis_hasting(300, x_0 = 500, b = burnin, proposal = "chisquared", keep_burnin = TRUE)

plotdf = data.frame(index = 1:length(results), values = results)

ggplot(plotdf) +
  geom_line(aes(x = index, y = values), color = "#6091ec") +
  labs(title = "Traceplot For The Burn-In Period (burnin = 100)", y = "X*",
  x = "Iteration", color = "Legend") +
  geom_vline(xintercept = burnin, color = "#C70039") + 
  theme_minimal()
...
**Answer:** They look almost the same. We assume as long as the proposal distribution mostly covers the target distribution the Metropolis-Hasting works quite well.
