...
$$p(\vec{\mu}|\vec{y}) \propto e^{-\frac{\left({\color{red}-\mu_1}-\frac{\mu_2+y_1}{2}\right)^2}{\sigma^2} -\frac{\left({\color{blue}-\mu_2}-\frac{\mu_3+y_2}{2}\right)^2}{\sigma^2} - \: ... \: -\frac{\left({\color{orange}-\mu_{n-1}}-\frac{\mu_n+y_{n-1}}{2}\right)^2}{\sigma^2} -\frac{\left( y_n - {\color{magenta}\mu_n}\right)^2}{\sigma^2}}$$
